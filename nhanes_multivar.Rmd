...
```{r}
Hmisc::redun( ~ age +gender+ bmi+ sys+ lbxtc+  lbdhdd+ smokecigs + drinkstatus + diabetes+ chf+ cancer + stroke  , data = a_nhanes)
```
...
s <-
  Hmisc::summaryM(
     age+bmi+ educationadult+ sys+ lbxtc+  lbdhdd+ smokecigs + drinkstatus+  diabetes+ chf+ cancer + stroke ~ gender,
    data = a_nhanes,
    overall = FALSE,
    test = FALSE
  )
