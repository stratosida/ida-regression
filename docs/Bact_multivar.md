...
```r
ggplot(c_bact, aes(t_KREA, eGFR))+geom_point() + geom_smooth()
```
...
c_bact %>%
ggplot(data=c_bact, mapping=aes(x=Alter, y=t_WBC, color=gender)) + geom_point() + geom_smooth()
```
...
## 
##     t_EOS I(t_BASO)     t_NEU     t_LYM      MONO     t_WBC 
##     0.177     0.179     0.982     0.666     0.502     0.985 
## 
## Rendundant variables:
## 
## t_WBC
...
<img src="Bact_multivar_files/figure-html/unnamed-chunk-15-1.png" width="672" />
...
## 
##   I(t_EOS)  I(t_BASO)      t_LYM       MONO      t_NEU      Alter        sex 
##      0.251      0.244      0.389      0.426      0.425      0.612      0.321 
## t_BUN_KREA       eGFR          K        FIB        CRP     t_ASAT     t_ALAT 
##      0.376      0.637      0.300      0.670      0.659      0.874      0.762 
##      t_GGT        MCV        HGB        HCT        MCH       MCHC        RDW 
##      0.643      0.993      0.996      0.996      0.995      0.984      0.530 
##        MPV         NT     t_APTT        NA.         CA     t_PHOS         MG 
##      0.905      0.340      0.257      0.335      0.530      0.314      0.244 
##         HS     t_GBIL         TP        ALB      t_AMY     t_PAMY      t_LIP 
...
##  [1] mice_3.13.0      ggcorrplot_0.1.3 gtsummary_1.4.1  Hmisc_4.5-0     
##  [5] Formula_1.2-4    survival_3.2-11  lattice_0.20-44  plotly_4.9.3    
...
## [13] mgcv_1.8-35         DBI_1.1.1           lazyeval_0.2.2     
## [16] colorspace_2.0-1    nnet_7.3-16         withr_2.4.2        
## [19] tidyselect_1.1.1    gridExtra_2.3       compiler_4.1.0     
## [22] cli_2.5.0           rvest_1.0.0         gt_0.3.0           
## [25] htmlTable_2.2.1     xml2_1.3.2          labeling_0.4.2     
## [28] bookdown_0.22       sass_0.4.0          scales_1.1.1       
## [31] checkmate_2.0.0     digest_0.6.27       foreign_0.8-81     
## [34] rmarkdown_2.8       base64enc_0.1-3     jpeg_0.1-8.1       
## [37] pkgconfig_2.0.3     htmltools_0.5.1.1   highr_0.9          
## [40] dbplyr_2.1.1        htmlwidgets_1.5.3   rlang_0.4.11       
## [43] readxl_1.3.1        rstudioapi_0.13     farver_2.1.0       
## [46] jquerylib_0.1.4     generics_0.1.0      jsonlite_1.7.2     
## [49] crosstalk_1.1.1     magrittr_2.0.1      Matrix_1.3-3       
## [52] Rcpp_1.0.6          munsell_0.5.0       fansi_0.4.2        
## [55] lifecycle_1.0.0     stringi_1.6.2       yaml_2.2.1         
## [58] plyr_1.8.6          grid_4.1.0          crayon_1.4.1       
## [61] haven_2.4.1         splines_4.1.0       hms_1.1.0          
## [64] knitr_1.33          pillar_1.6.1        reshape2_1.4.4     
## [67] reprex_2.0.0        glue_1.4.2          evaluate_0.14      
## [70] latticeExtra_0.6-29 broom.helpers_1.3.0 data.table_1.14.0  
## [73] modelr_0.1.8        png_0.1-7           vctrs_0.3.8        
## [76] cellranger_1.1.0    gtable_0.3.0        assertthat_0.2.1   
## [79] xfun_0.23           broom_0.7.6         viridisLite_0.4.0  
