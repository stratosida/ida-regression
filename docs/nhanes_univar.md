...
iVBORw0KGgoAAAANSUhEUgAAAA0AAAANCAMAAABFNRROAAAACVBMVEUAAADMzMz////1iUV5AAAAJElEQVQImWNgYEQCDAxMSIAQDyGCzgOZhGwmbpWEeRAMMxOCAVlGAOmSq8J/AAAAAElFTkSuQmCC" alt="image" /></div> <style>
 ...
 <table class="hmisctable330164">
 <tr><th>n</th><th>missing</th><th>distinct</th></tr>
 <tr><td>6680</td><td>0</td><td>4</td></tr>
 </table>
 <pre style="font-size:85%;">
 Value      Moderate Drinker      Non-Drinker    Heavy Drinker  Missing alcohol
 Frequency              3449             2336              429              466
 Proportion            0.516            0.350            0.064            0.070
 </pre>
 <hr class="thinhr">
```
...
bottom: -1ex;
 ...
 <font color="MidnightBlue"><div align=center><span style="font-weight:bold">Physiological measurements <br><br> 3  Variables   6680  Observations</span></div></font> <hr class="thinhr"> <span style="font-weight:bold">sys</span>: Systolic blood pressure <span style='font-family:Verdana;font-size:75%;'>mg/dl</span><div style='float: right; text-align: right;'><img src="data:image/png;base64,
