...
### Distribution of Glasgow comma score by sex

```{r, message=FALSE, warning =FALSE , echo=FALSE, fig.cap= "Distribution of Glasgow comma score (point scale) by sex", fig.height=6}
...
```{r, message=FALSE, warning =FALSE , echo=FALSE, fig.cap= "Distribution of centrail capillary refille time by gcs" }
a_crash2 %>%
  filter(!(is.na(age_C))) %>%
  with(., histboxp(
    x =  cc,
...
html(
  s,
  caption = 'Baseline characteristics by Glasgow comma score',
  exclude1 = TRUE,
  npct = 'both',
  digits = 3,
  prmsd = TRUE,
...
### Distribution of age by Glasgow comma score
...
### Distribution of systolic blood pressure by Glasgow comma score
...
### Distribution of heart rate by Glasgow comma score
...
### Distribution of respiratory rate by Glasgow comma score
...
### Distribution of central capillary refille time by Glasgow comma score
