...
```{r}
ggplot(c_bact, aes(MPV, PDW))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(RBC, HGB))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(RBC, HCT))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(HGB, HCT))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(MCV, MCH))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(t_CREA, eGFR))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()


ggplot(c_bact, aes(t_ASAT, t_ALAT))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()

ggplot(c_bact, aes(t_AMY, t_PAMY))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()


ggplot(c_bact, aes(t_WBC, t_NEU))+geom_point(alpha = alpha_value) + geom_smooth() +
    theme_minimal()
