...
pa_vars <- c("mobilityproblem", "tac" ,"tlac" ,"mvpa" ,  "wt" , "tlac.1", "tlac.2","tlac.3","tlac.4","tlac.5","tlac.6","tlac.7","tlac.8","tlac.9","tlac.10","tlac.11","tlac.12" )
...
```{r catplot, message=FALSE, warning =FALSE , echo=FALSE, fig.height=10}
a_nhanes %>%
...
```{r, fig.width=8, fig.height=3.5, fig.cap= "Distribution of log(1+MVPA) " , echo=FALSE}
## This is a function the plots a strip plot, histogram and boxplot, including five number summary. 
a_nhanes <- a_nhanes %>%
            mutate(mvpa_log = log(1+mvpa))

ida_plot_univar(a_nhanes, "mvpa_log", bin_width = 0.01)
```


```{r, fig.width=8, fig.height=3.5, fig.cap= "Distribution of wear time [minutes]" , echo=FALSE}
## This is a function the plots a strip plot, histogram and boxplot, including five number summary. 
ida_plot_univar(a_nhanes, "wt")
```


```{r, fig.width=8, fig.height=3.5, fig.cap= "Distribution of log total activity count" , echo=FALSE}
## This is a function the plots a strip plot, histogram and boxplot, including five number summary. 
