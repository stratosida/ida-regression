...
library(Hmisc)
library(gtsummary)
bact <- read.csv(here("data", "Bacteremia_public.csv"))
```
...
remaining_vars <- names(a_bact)[is.na(match(names(a_bact),c(demog_vars, pivotal_vars, vip_vars, leuko_related_vars, leuko_ratio_vars, kidney_related_vars, acute_related_vars, c("ID","BloodCulture","BC"))))]
```
